...
public class BookProvider extends ContentProvider {
    ...
    static {
        ...
        // The content URI of the form "content://com.example.bianc.bookstoreinventory/books/" will
        // map to the integer code {@link #BOOKS}. This URI is used to provide access to MULTIPLE rows
        // of the books table.
        ...
        // For example, "content://com.example.bianc.bookstoreinventory/books/3" matches, but
        // "content://com.example.bianc.bookstoreinventory/books" (without a number at the end) doesn't match.
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            case BOOK_ID:
                ...
                // For an example URI such as "content://com.example.bianc.bookstoreinventory/books/3",
    ...
    private Uri insertBook(Uri uri, ContentValues values) {
        ...
        // Check that the price is not null and not less than 0
        Long price = values.getAsLong(BookEntry.COLUMN_BOOK_PRICE);
        if (price == null || price < 0) {
            throw new IllegalArgumentException("Book requires a price");
        }

        // Check that the quantity is not null and not less than 0
