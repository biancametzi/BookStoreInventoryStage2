...
public class EditorActivity extends AppCompatActivity implements
    ...
    /**
     * Button to increase the book quantity
     */
    private Button mIncreaseButton;

    /**
     * Button to decrease the book quantity
     */
    private Button mDecreaseButton;

    /**
     * Button for ordering a book that sends an intent to call the supplier
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCurrentBookUri = bookIntent.getData();
        ...
        mIncreaseButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(quantity)) {
                    mQuantityEditText.setText(Integer.toString(increaseQuantity));
                } else {
                    int productQuantityInt = Integer.parseInt(quantity);
                    int newQuantity = productQuantityInt + increaseQuantity;
        ...
        mDecreaseButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String product = mQuantityEditText.getText().toString().trim();
                int decreaseQuantity = 1;
                if (TextUtils.isEmpty(product)) {
                    mQuantityEditText.setText(Integer.toString(0));
                } else {
                    int productQuantityInt = Integer.parseInt(product);
                    if (productQuantityInt > 0) {
                        int newQuantity = productQuantityInt - decreaseQuantity;
                        mQuantityEditText.setText(Integer.toString(newQuantity));
                    } else {
    ...
    private void saveBook() {
        ...
        if (TextUtils.isEmpty(titleString) || TextUtils.isEmpty(authorString) ||
            ...
            if (TextUtils.isEmpty(titleString)) {
                mFormErrorsMessage += getString(R.string.title_required);
            }

            if (TextUtils.isEmpty(authorString)) {
                mFormErrorsMessage += "\n" + getString(R.string.author_required);
            }
            ...
            if (TextUtils.isEmpty(supplierNameString)) {
                mFormErrorsMessage += "\n" + getString(R.string.supplier_name_required);
            }

            if (TextUtils.isEmpty(supplierPhoneNumberString)) {
                mFormErrorsMessage += "\n" + getString(R.string.supplier_phone_required);
            }
