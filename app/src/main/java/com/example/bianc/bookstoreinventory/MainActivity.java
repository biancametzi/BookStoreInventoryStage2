...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent bookIntent = new Intent(MainActivity.this, EditorActivity.class);
    ...
    private void insertBook() {
        ...
        values.put(BookEntry.COLUMN_BOOK_TITLE, "The Secret Keeper");
        values.put(BookEntry.COLUMN_BOOK_AUTHOR, "Kate Morton");
        values.put(BookEntry.COLUMN_BOOK_PRICE, "8");
        values.put(BookEntry.COLUMN_BOOK_QUANTITY, "5");
        values.put(BookEntry.COLUMN_BOOK_SUPPLIER_NAME, "Pan Books");
        values.put(BookEntry.COLUMN_BOOK_SUPPLIER_PHONE_NUMBER, "02070146000");
    ...
    /**
     * Helper method to delete all bookss in the database.
     */
